# Generated by Powerlevel10k configuration wizard on 2022-05-25 at 22:05 EEST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 51782.
# Wizard options: awesome-fontconfig + powerline + python, large icons, unicode,
# lean_8colors, 24h time, 2 lines, disconnected, left frame, green-ornaments, sparse,
